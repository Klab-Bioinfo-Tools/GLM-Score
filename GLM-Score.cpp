...
while (!ligtmp.eof())

   {
     ...
     ligtmp.get(atomo,sizeof(atomo),'\0');
     ligtmp.get(espaco_1,sizeof(espaco_1),'\0');
     ligtmp.get(nome_atomo,sizeof(nome_atomo),'\0');
     ligtmp.get(espaco_2,sizeof(espaco_2),'\0');
     ligtmp.get(x,sizeof(x),'\0');
     ligtmp.get(espaco_3,sizeof(espaco_3),'\0');
     ligtmp.get(y,sizeof(y),'\0');
     ligtmp.get(espaco_4,sizeof(espaco_4),'\0');
     ligtmp.get(z,sizeof(z),'\0');
     ligtmp.get(espaco_5,sizeof(espaco_5),'\0');
     ligtmp.get(hibr,sizeof(hibr),'\0');
     ligtmp.get(enter,sizeof(enter),'\0');

if (nome_atomo[0]=='\0'||espaco_1[0]=='\0'||nome_atomo[0]=='\0'||espaco_2[0]=='\0'||x[0]=='\0'||espaco_3[0]=='\0'||y[0]=='\0'||espaco_4[0]=='\0'||z[0]=='\0'||espaco_5[0]=='\0'||hibr[0]=='\0'||enter[0]=='\0'){break;}

//cout << nome_atomo << endl;

//--------LIGANTE-------------RADII-Raio-de-VDW-PERMITIDOS

if (hibr[0]=='N' && hibr[1]=='.' && hibr[2]=='3')
{
r2 = 1.87;
}

if (hibr[0]=='N' && hibr[1]=='.' && (hibr[2]=='2' || hibr[2]=='1' || (hibr[2]=='a' && hibr[3]=='r')) || hibr[2]=='p')
{
r2 = 1.86;
}

if (hibr[0]=='N' && hibr[1]=='.' && hibr[2]=='a' && hibr[3]=='m')
{
r2 = 1.83;
}


if (hibr[0]=='C' && hibr[1]=='.' && hibr[2]=='3')
{
r2 = 1.94;
}

if (hibr[0]=='C' && hibr[1]=='.' && (hibr[2]=='2' || hibr[2]=='1'))
{
r2 = 1.90;
}

if (hibr[0]=='C' && hibr[1]=='.' && hibr[2]=='a' && hibr[3]=='r')
{
r2 = 1.85;
}

if (hibr[0]=='O' && hibr[1]=='.' && hibr[2]=='3')
{
r2 = 1.74;
}

if (hibr[0]=='O' && hibr[1]=='.' && hibr[2]=='2')
{
r2 = 1.66;
}

if (hibr[0]=='F' || (hibr[0]=='O' && hibr[1]=='.' && hibr[2]=='w'))
{
r2 = 1.77;
}

if (hibr[0]=='S' && hibr[1]=='.' && hibr[2]=='3')
{
r2 = 2.09;
}
...
if (hibr[0]=='C' && hibr[1]=='l' && hibr[2]==' ')
{
r2 = 2.00;
}

if (hibr[0]=='B' && hibr[1]=='r' && hibr[2]==' ')
{
r2 = 2.22;
}

if (hibr[0]=='I' && hibr[1]==' ' && hibr[2]==' ')
{
r2 = 2.42;
}
...
num_atomo = atoi(atomo);	 
 
//	 cout << "convertendo caracteres do ligante\n" << endl;
     
     if (x[0]==' '){x[0]==x[1]; x[1]==x[2]; x[2]==x[3]; x[3]==x[4]; x[4]==x[5]; x[5]==x[6]; x[6]==x[7]; x[8]==x[9]; x[9]==x[10]; }
     if (x[0]==' '){x[0]==x[1]; x[1]==x[2]; x[2]==x[3]; x[3]==x[4]; x[4]==x[5]; x[5]==x[6]; x[6]==x[7]; x[8]==x[9]; x[9]==x[10]; }
     if (x[0]==' '){x[0]==x[1]; x[1]==x[2]; x[2]==x[3]; x[3]==x[4]; x[4]==x[5]; x[5]==x[6]; x[6]==x[7]; x[8]==x[9]; x[9]==x[10]; }
     if (x[0]==' '){x[0]==x[1]; x[1]==x[2]; x[2]==x[3]; x[3]==x[4]; x[4]==x[5]; x[5]==x[6]; x[6]==x[7]; x[8]==x[9]; x[9]==x[10]; }
...
//cout << endl;
     ...
     if (y[0]==' '){y[0]==y[1]; y[1]==y[2]; y[2]==y[3]; y[3]==y[4]; y[4]==y[5]; y[5]==y[6]; y[6]==y[7]; y[8]==y[9]; y[9]==y[10]; }
     if (y[0]==' '){y[0]==y[1]; y[1]==y[2]; y[2]==y[3]; y[3]==y[4]; y[4]==y[5]; y[5]==y[6]; y[6]==y[7]; y[8]==y[9]; y[9]==y[10]; }
     if (y[0]==' '){y[0]==y[1]; y[1]==y[2]; y[2]==y[3]; y[3]==y[4]; y[4]==y[5]; y[5]==y[6]; y[6]==y[7]; y[8]==y[9]; y[9]==y[10]; }
     if (y[0]==' '){y[0]==y[1]; y[1]==y[2]; y[2]==y[3]; y[3]==y[4]; y[4]==y[5]; y[5]==y[6]; y[6]==y[7]; y[8]==y[9]; y[9]==y[10]; }
...
//cout << endl;
     ...
     if (z[0]==' '){z[0]==z[1]; z[1]==z[2]; z[2]==z[3]; z[3]==z[4]; z[4]==z[5]; z[5]==z[6]; z[6]==z[7]; z[8]==z[9]; z[9]==z[10]; }
     if (z[0]==' '){z[0]==z[1]; z[1]==z[2]; z[2]==z[3]; z[3]==z[4]; z[4]==z[5]; z[5]==z[6]; z[6]==z[7]; z[8]==z[9]; z[9]==z[10]; }
     if (z[0]==' '){z[0]==z[1]; z[1]==z[2]; z[2]==z[3]; z[3]==z[4]; z[4]==z[5]; z[5]==z[6]; z[6]==z[7]; z[8]==z[9]; z[9]==z[10]; }
     if (z[0]==' '){z[0]==z[1]; z[1]==z[2]; z[2]==z[3]; z[3]==z[4]; z[4]==z[5]; z[5]==z[6]; z[6]==z[7]; z[8]==z[9]; z[9]==z[10]; }
...
protmp.get(p_atomo,sizeof(p_atomo),'\0');  
protmp.get(p_nome_atomo,sizeof(p_nome_atomo),'\0');  
protmp.get(p_aminoacido,sizeof(p_aminoacido),'\0'); 
protmp.get(p_num_aminoacido,sizeof(p_num_aminoacido),'\0');  
protmp.get(px,sizeof(px),'\0');  
protmp.get(py,sizeof(py),'\0');  
protmp.get(pz,sizeof(pz),'\0');  
protmp.get(p_enter,sizeof(p_enter),'\0'); 
...
num_p_atomo = atoi(p_atomo);
     ...
     if (px[0]==' '){px[0]==px[1]; px[1]==px[2]; px[2]==px[3]; px[3]==px[4]; px[4]==px[5]; px[5]==px[6]; px[6]==px[7]; px[8]==px[9]; px[9]==px[10]; }
     if (px[0]==' '){px[0]==px[1]; px[1]==px[2]; px[2]==px[3]; px[3]==px[4]; px[4]==px[5]; px[5]==px[6]; px[6]==px[7]; px[8]==px[9]; px[9]==px[10]; }
     if (px[0]==' '){px[0]==px[1]; px[1]==px[2]; px[2]==px[3]; px[3]==px[4]; px[4]==px[5]; px[5]==px[6]; px[6]==px[7]; px[8]==px[9]; px[9]==px[10]; }
     if (px[0]==' '){px[0]==px[1]; px[1]==px[2]; px[2]==px[3]; px[3]==px[4]; px[4]==px[5]; px[5]==px[6]; px[6]==px[7]; px[8]==px[9]; px[9]==px[10]; }
...
//cout << endl;
     ...
     if (py[0]==' '){py[0]==py[1]; py[1]==py[2]; py[2]==py[3]; py[3]==py[4]; py[4]==py[5]; py[5]==py[6]; py[6]==py[7]; py[8]==py[9]; py[9]==py[10]; }
     if (py[0]==' '){py[0]==py[1]; py[1]==py[2]; py[2]==py[3]; py[3]==py[4]; py[4]==py[5]; py[5]==py[6]; py[6]==py[7]; py[8]==py[9]; py[9]==py[10]; }
     if (py[0]==' '){py[0]==py[1]; py[1]==py[2]; py[2]==py[3]; py[3]==py[4]; py[4]==py[5]; py[5]==py[6]; py[6]==py[7]; py[8]==py[9]; py[9]==py[10]; }
     if (py[0]==' '){py[0]==py[1]; py[1]==py[2]; py[2]==py[3]; py[3]==py[4]; py[4]==py[5]; py[5]==py[6]; py[6]==py[7]; py[8]==py[9]; py[9]==py[10]; }
...
//cout << endl;
     ...
     if (pz[0]==' '){pz[0]==pz[1]; pz[1]==pz[2]; pz[2]==pz[3]; pz[3]==pz[4]; pz[4]==pz[5]; pz[5]==pz[6]; pz[6]==pz[7]; pz[8]==pz[9]; pz[9]==pz[10]; }
     if (pz[0]==' '){pz[0]==pz[1]; pz[1]==pz[2]; pz[2]==pz[3]; pz[3]==pz[4]; pz[4]==pz[5]; pz[5]==pz[6]; pz[6]==pz[7]; pz[8]==pz[9]; pz[9]==pz[10]; }
     if (pz[0]==' '){pz[0]==pz[1]; pz[1]==pz[2]; pz[2]==pz[3]; pz[3]==pz[4]; pz[4]==pz[5]; pz[5]==pz[6]; pz[6]==pz[7]; pz[8]==pz[9]; pz[9]==pz[10]; }
     if (pz[0]==' '){pz[0]==pz[1]; pz[1]==pz[2]; pz[2]==pz[3]; pz[3]==pz[4]; pz[4]==pz[5]; pz[5]==pz[6]; pz[6]==pz[7]; pz[8]==pz[9]; pz[9]==pz[10]; }
...
if (p_nome_atomo[0]=='N' && p_nome_atomo[1]!='Z')
{
r1 = 1.65;
}
...
//TERMINA (ACHA DISTANCIA PERMITIDA)

/*
tabela radii - ligante
C.3	1.94
C.2	1.90
C.1	1.90
C.ar	1.85
...
//funcao para o RT
if (DIS2<=(permitido+extended) && nome_atomo[0]!='H')
{
//cout << atomo[1] << atomo[2] << atomo[3] << atomo[4] << atomo[5] << atomo[6] << endl;
if (atomo[1]=='\0'){RT_found << " ";}
if (atomo[1]!='\0'){RT_found << atomo[1];}

if (atomo[2]=='\0'){RT_found << " ";}
if (atomo[2]!='\0'){RT_found << atomo[2];}

if (atomo[3]=='\0'){RT_found << " ";}
if (atomo[3]!='\0'){RT_found << atomo[3];}

if (atomo[4]=='\0'){RT_found << " ";}
if (atomo[4]!='\0'){RT_found << atomo[4];}

if (atomo[5]=='\0'){RT_found << " ";}
if (atomo[5]!='\0'){RT_found << atomo[5];}

if (atomo[6]=='\0'){RT_found << " ";}
if (atomo[6]!='\0'){RT_found << atomo[6];}

RT_found << endl;

}

if (hibr[0]!='H' && atomo[0]!='H')
{
//funcao para o VDW
...
if (p_nome_atomo[0]=='C' && (nome_atomo[0]=='C' || nome_atomo[1]=='C'))
{
...
if (DIS2<=permitido && nome_atomo[0]!='H') {
repulsive++;
...
{
if ((p_nome_atomo[0]=='N' || p_nome_atomo[0]=='O' || p_nome_atomo[0]=='S') && (nome_atomo[0]=='N' || nome_atomo[0]=='O' || nome_atomo[0]=='S'||nome_atomo[1]=='N' || nome_atomo[1]=='O' || nome_atomo[1]=='S'))
...
//if ((num_p_atomo != num_p_atomo_copia) && (num_p_atomo > num_p_atomo_copia))
//{
//num_p_atomo_copia = num_p_atomo; 
//num_atomo_copia = num_atomo; 
//cout << num_p_atomo_copia << num_p_atomo;

n = 0;
while (n<(sizeof atomo - 1))
{ldistmp.put(atomo[n]); n++;}
n = 0;
while (n<(sizeof espaco_1 - 1))
{ldistmp.put(espaco_1[n]); n++;}
n = 0;
while (n<(sizeof nome_atomo - 1))
{ldistmp.put(nome_atomo[n]); n++;}
n = 0;
while (n<(sizeof espaco_2 - 1))
{ldistmp.put(espaco_2[n]); n++;}
n = 0;
while (n<(sizeof x - 1))
{ldistmp.put(x_copia[n]); n++;}
n = 0;
while (n<(sizeof espaco_3 - 1))
{ldistmp.put(espaco_3[n]); n++;}
n = 0;
while (n<(sizeof y - 1))
{ldistmp.put(y_copia[n]); n++;}
n = 0;
while (n<(sizeof espaco_4 - 1))
{ldistmp.put(espaco_4[n]); n++;}
n = 0;
while (n<(sizeof z - 1))
{ldistmp.put(z_copia[n]); n++;}
n = 0;
while (n<(sizeof espaco_5 - 1))
{ldistmp.put(espaco_5[n]); n++;}
n = 0;
while (n<(sizeof hibr - 1))
{ldistmp.put(hibr[n]); n++;}
n = 0;
while (n<(sizeof enter - 1))
{ldistmp.put(enter[n]); n++;}
n = 0;


//proteina: salva arquivo tmp com os atomos mais pr�imos
while (n<(sizeof p_atomo - 1))
{pdistmp.put(p_atomo[n]); n++;}
n = 0;
while (n<(sizeof p_nome_atomo - 1))
{pdistmp.put(p_nome_atomo[n]); n++;}
n = 0;
while (n<(sizeof p_aminoacido - 1))
{pdistmp.put(p_aminoacido[n]); n++;}
n = 0;
while (n<(sizeof p_num_aminoacido - 1))
{pdistmp.put(p_num_aminoacido[n]); n++;}
n = 0;
while (n<(sizeof px - 1))
{pdistmp.put(px_copia[n]); n++;}
n = 0;
while (n<(sizeof py - 1))
{pdistmp.put(py_copia[n]); n++;}
n = 0;
while (n<(sizeof pz - 1))
{pdistmp.put(pz_copia[n]); n++;}
n = 0;
while (n<(sizeof p_enter - 1))
{pdistmp.put(p_enter[n]); n++;}
n = 0;
...
//ligante: salva arquivo tmp com os atomos mais pr�imos


/*if ((num_atomo != num_atomo_copia) && (num_atomo > num_atomo_copia))
{
num_atomo_copia = num_atomo;}
*/
//cout << num_atomo_copia << num_atomo;

//}
/*
ldistmp.out(atomo);
ldistmp.out(espaco_1);
ldistmp.out(nome_atomo);
ldistmp.out(espaco_2);
ldistmp.put(x);
ldistmp.put(espaco_3);
ldistmp.put(y);
ldistmp.put(espaco_4);
ldistmp.put(z);
ldistmp.put(espaco_5);
ldistmp.put(hibr);
ldistmp.put(enter);
*/
...
/*
pdistmp.close(p_atomo);
pdistmp.close(p_nome_atomo);
pdistmp.close(p_aminoacido);
pdistmp.close(p_num_aminoacido);
pdistmp.close(px);
pdistmp.close(py);
pdistmp.close(pz);
pdistmp.close(p_enter);
*/
}
...
qscore.open("qscore.txt", ios::app);
//cout << "Deformation effect: " << RT << "\t" << endl;
//qscore << RT << "\t";
//cout <<  endl << "@" << atom_0[0] << "@" ;
//cout << atom_0[1]<< "@" ;
qscore.close();
...
double equation_8 = 0; 
double equation_9 = 0; 
double equation_10 = 0; 
double equation_11 = 0; 
double equation_12 = 0; 
double equation_13 = 0; 
double equation_14 = 0; 
double equation_15 = 0; 
double equation_16 = 0; 
double equation_17 = 0; 
double equation_18 = 0; 
double equation_19 = 0; 
double equation_20 = 0; 
double equation_21 = 0; 
double equation_22 = 0; 
double equation_23 = 0; 
double equation_24 = 0; 
double equation_25 = 0; 
double equation_26 = 0; 
double equation_27 = 0; 
double equation_28 = 0; 
double equation_29 = 0; 
double equation_30 = 0; 
double equation_31 = 0; 
...
//cout << "            QSCORE(polynomial empirical scoring functions)" << endl;
//cout << "---------------------------------------------------------------------------------" << endl;
//cout << endl;
//cout << "Experimental pKD: \t\t" << pKD << endl;
...
qscore << "Hydrophobic contacts:        " << HC_total2 << endl;
qscore << "Van der waals:               " << VDW_total << endl;
qscore << "Deformation effect:          " << RT << endl;
qscore << "Hydrogen bonds (HB):         " << HB << endl;
qscore << "Repulsive VDW score:         " << repulsive << endl;
qscore << "London dispersion force:     " << london << endl;
...
//(Intercept) + HC_total2 + VDW_total + RT + HB  + ASA1 + ASA2 + repulsive + london + summation(HC_total2,RT) + summation(VDW_total,RT) + summation(RT,HB) + summation(VDW_total,ASA1) + summation(HC_total2,ASA2) + summation(VDW_total,ASA2)  + summation(ASA1,ASA2) + summation(RT,repulsive) + summation(ASA1,repulsive) + summation(HC_total2,london) + summation(RT,london)
//improve this later
//equation_8 = (6.33291400000000*1) + (-0.00214057000000*HC_total2) + (-0.00043940590000*VDW_total) + (0.00873261800000*RT) + (0.22767440000000*HB ) + (-0.00000611991600*ASA1) + (0.00000360224600*ASA2) + (-0.24256690000000*repulsive) + (0.66662510000000*london) + (0.00005875461000*summation(HC_total2,RT)) + (0.00002997215000*summation(VDW_total,RT)) + (-0.00230000500000*summation(RT,HB)) + (0.00000001884578*summation(VDW_total,ASA1)) + (0.00000004075349*summation(HC_total2,ASA2)) + (0.00000002839609*summation(VDW_total,ASA2) ) + (0.00000000519708*summation(ASA1,ASA2)) + (0.00598323000000*summation(RT,repulsive)) + (0.00000025789670*summation(ASA1,repulsive)) + (-0.00001361793000*summation(HC_total2,london)) + (-0.01620494000000*summation(RT,london));
//cout << "GLM binding affinity result (pKd):      " << equation_8 << endl;
...
remove("RT_found.tmp");
remove("pKd_eq1_list.tmp");
remove("pKd_eq2_list.tmp");
remove("pKd_eq3_list.tmp");
remove("pKd_eq4_list.tmp");
remove("pKd_eq5_list.tmp");
remove("pKd_eq6_list.tmp");
remove("pKd_eq7_list.tmp");
remove("pKd_eq8_list.tmp");
remove("pKd_eq9_list.tmp");
remove("pKd_eq10_list.tmp");
remove("pKd_eq11_list.tmp");
remove("pKd_eq12_list.tmp");
remove("pKd_eq13_list.tmp");
remove("pKd_eq14_list.tmp");
remove("pKd_eq15_list.tmp");
remove("pKd_eq16_list.tmp");
remove("pKd_eq17_list.tmp");
remove("pKd_eq18_list.tmp");
remove("pKd_eq19_list.tmp");
remove("pKd_eq20_list.tmp");
remove("pKd_eq21_list.tmp");
remove("pKd_eq22_list.tmp");
remove("pKd_eq23_list.tmp");
remove("pKd_eq24_list.tmp");
remove("pKd_eq25_list.tmp");
//system ("pause");
}
